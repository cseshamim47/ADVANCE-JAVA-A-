...
public class StudentRepository {
    ...
    public Student get(String email) throws SQLException {
        ...
        while (resultSet.next()) {
            return new Student(resultSet.getInt("id"),resultSet.getString("name"), resultSet.getString("email"), resultSet.getString("password"), resultSet.getDate("date_of_birth").toLocalDate(), Gender.valueOf(resultSet.getString("gender").toUpperCase()),resultSet.getString("quota"),resultSet.getString("country"));
        }
        return new Student();
    }
}
