...
public class StudentRepository {
    ...
    public List<Student> findAll() throws SQLException {
        ...
        String sql = "SELECT id, name, email, dateOfBirth, gender, quota, country FROM students";
    ...
    public void updateStudentById(Student updatedStudent) throws SQLException {
        Connection connection = dataSource.getConnection();
        String sql = "UPDATE students SET name=?, email=?, dateOfBirth=?, gender=?, quota=?, country=? WHERE id=?";
        try (PreparedStatement preparedStatement = connection.prepareStatement(sql)) {
